...
<div class="navbar">
    ...
    <div class="container">
            <input required="" type="text" class="input" name="Email" value="<?php echo isset($_SESSION['SignUpEmail']) ? htmlspecialchars($_SESSION['SignUpEmail']) : ''; ?>">
            <label class="label">Email</label>
            </div>
            <br>
    <div class="container">
            <input required="" type="text" class="input" name="username" value="<?php echo isset($_SESSION['SignUpUserName']) ? htmlspecialchars($_SESSION['SignUpUserName']) : ''; ?>">
            ...
            <br>
            <div><a href="loginPage.php">Have an account?</a></div>
            <br>
